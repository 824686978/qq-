...
__DEFINE__(1650617806801, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1650617806802,"./event-store":1650617806803}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1650617806802, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1650617806803, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1650617806802,"./utils":1650617806804}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1650617806804, function(require, module, exports) {
...
return __REQUIRE__(1650617806801);
})()
